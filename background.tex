...
Using little theories maximizes reuse of results. Results proven in the theory \lstmath{$\Gamma$} can be transported to all theories connected to \lstmath{$\Gamma$} via morphisms\footnote{Only the morphisms that has $\Gamma$ as a source}. This emphasizes the role of morphisms for increasing usability and reducing redundancy when dealing with formal systems.  
