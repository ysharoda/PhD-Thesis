...
\titlegraphic{
\vspace{-0.5cm}
\hspace*{8.5cm}\includegraphics[width=2cm]{figures/mac-logo.png}
}
...
{\scriptsize
\begin{tikzcd}[row sep=2.0em, column sep=2.5em]
    \verb|Monoid| \arrow[r,hook] \arrow[d,mapsto]  & \verb|Group| \\
    \verb|AdditiveMonoid| & 
\end{tikzcd}
}
\end{column}
...
{\scriptsize
\begin{tikzcd}[row sep=2.0em, column sep=2.5em]
    \verb|Carrier| \arrow[r,hook] \arrow[d,mapsto]  & \verb|MultMonoid| \\
    \verb|AdditiveMonoid| & 
\end{tikzcd}
}
\end{column}
...
\begin{frame}[fragile] 
\frametitle{Constructions for Free!} 
\input{figures/monoid-hom-rel2.tex}
...
\input{figures/monoid-hom-rel3.tex}
...
\end{minted}
Isabelle: 
\begin{minted}[escapeinside=||,mathescape=true,fontsize=\scriptsize]{Isabelle}
locale monoid =
  fixes G (structure)
...
{\scriptsize
\begin{tikzcd} 
\verb|Carrier| \arrow[r,blue,hook] \arrow[d,blue,hook] \arrow[rd,blue,hook] & \verb|UnaryOperation| \arrow[r,blue,hook] \arrow[d,hook] & \verb|Involution| \\ 
\verb|Magma| \arrow[r,hook] & \verb|InvolutiveMagmaSig| \arrow [d,hook,blue] & \\ 
& \verb|UnaryAntiDistribution| 
\end{tikzcd}}
\end{frame}
