...
\end{lstlisting} 
\end{comment}
\ednote{Check: Modular structures as dependent types in Isabelle: 
\url{http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.33.2135&rep=rep1&type=pdf}}
...
\ednote{check this: automating inversion of inductive predicates in Coq}
...
Lem: reusable engineering of real-world semantics (https://www.cl.cam.ac.uk/~pes20/lem/built-doc/lem-icfp-2014.pdf)
